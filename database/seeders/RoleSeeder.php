...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       Permission::create(['name' => 'admin.home',
                'description' => 'Ver el Dashboar'])->syncRoles([$role1, $role2]);
      ...
      /* Permission::create(['name' => 'admin.users.update','description' => ''])->syncRoles([$role1]);*/
       ...
       Permission::create(['name' => 'admin.posts.index','description' => 'Ver losta de Posts'])->syncRoles([$role1, $role2]);
       ...
       Permission::create(['name' => 'admin.posts.destroy','description' => 'Elimiar Posts'])->syncRoles([$role1, $role2]);
